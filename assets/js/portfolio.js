  ...
  const portfolioData = [
    ...
    },
    {
      ...
      descriptionHtml: `
        ...
        <div style="display: flex; gap: 20px; margin: 24px 0; clear: both; flex-wrap: wrap; justify-content: center; align-items: flex-start;">
          ...
          <figure class="project-figure object-cover" style="height: auto; width: 100%; flex: 0 0 300px;">
